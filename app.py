...
def search_venues():
  ...
  searchingTerm = request.form['search_term']
  data = []
  requiredVenues = Venue.query.filter(Venue.name.ilike('%'+searchingTerm+'%'))
...
def search_artists():
  ...
  searchingTerm = request.form['search_term']
  data = []
  requiredVenues = Artist.query.filter(Artist.name.ilike('%'+searchingTerm+'%'))
